...
export type ResolversTypes = ResolversObject<{
  ...
  Booking: ResolverTypeWrapper<./src/models/models.ts>;
  ...
  Room: ResolverTypeWrapper<./src/models/models.ts>;
  ...
  User: ResolverTypeWrapper<./src/models/models.ts>;
  userRole: UserRole;
}>;
